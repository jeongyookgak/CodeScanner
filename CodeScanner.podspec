#
#  Be sure to run `pod spec lint CodeScanner.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.version      = "1.0.7"
  spec.summary      = "A SwiftUI view that is able to scan barcodes, QR codes, and more, and send back what was found."
  ...
  spec.source       = { :git => "https://github.com/getogrand/CodeScanner.git", :branch => "main" }
  ...
  spec.source_files  = "Sources/CodeScanner/**/*.swift"
  ...
  spec.resource_bundle = {
    "CodeScanner" => "Sources/CodeScanner/Resources/*.xcassets"
  }
